...
while True:
    ...
    if choice == '1':
        ...
        if is_message:
            ...
            fh.write_binary_message("komunikat_po_transmisji_zakodowany.txt", encoded_message)
        ...
        if is_encoded:
            ...
            send_message = fh.read_binary_message("komunikat_po_transmisji_zakodowany.txt")
